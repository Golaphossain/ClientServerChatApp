...
We build a chat server application using socket programing. In this application has two parts. 1st part is client side application and other part is server side application. The whole project we developed in android platform. If anyone want to run the whole project, he should run server side and client side individually. The process of this application is given below:
...
Server side Application process:
